...
export function TripCard({ trip, onClick }: TripCardProps) {
  ...
  return (
    <div
      ...
      className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 hover:border-emerald-500/40 hover:scale-[1.01] transition-all cursor-pointer shadow-xl group"
    >
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4 mb-4">
        ...
        <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold text-xs rounded-full border border-slate-200 dark:border-slate-700">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <div className="flex items-baseline gap-1 text-slate-900 dark:text-white">
            ...
            <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">km</span>
          </div>
        </div>
        <div>
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Velo. Máx</p>
          <div className="flex items-baseline gap-1 text-emerald-500 dark:text-emerald-400">
            <span className="text-xl font-bold">{trip.maxSpeedKmh}</span>
            <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">km/h</span>
          </div>
        </div>
        <div>
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">RPM Máx</p>
          <div className="flex items-baseline gap-1 text-orange-500 dark:text-orange-400">
            <span className="text-xl font-bold">{trip.maxRpm}</span>
            <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">rpm</span>
          </div>
        </div>
      </div>
    </div>
